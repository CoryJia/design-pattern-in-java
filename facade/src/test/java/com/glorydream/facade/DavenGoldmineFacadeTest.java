 ...
 * @date 4/29/20 12:18 AM
 */
public class DavenGoldmineFacadeTest {
     ...
     * {@link DavenGoldmineFacade#startNewDay()},
     * {@link DavenGoldmineFacade#digOutGold()},
     * {@link DavenGoldmineFacade#endDay()}
     *
    ...
    public void testFullWorkDay(){
        final var goldMine = new DavenGoldmineFacade();
        ...
        assertTrue(appender.logContains("Dwarf tunnel digger wakes up."));
        ...
        assertTrue(appender.logContains("Dwarf tunnel digger goes to the mine."));
        ...
        assertTrue(appender.logContains("Dwarf tunnel digger creates another promising tunnel."));
        ...
        assertTrue(appender.logContains("Dwarf tunnel digger goes home."));
        ...
        assertTrue(appender.logContains("Dwarf tunnel digger goes to sleep."));
